...
button.o: ../../drivers/button.c ../../drivers/avr/pio.o ../../drivers/avr/system.h ../../drivers/button.h
	$(CC) -c $(CFLAGS) $< -o $@

# Link: create ELF output file from object files.
countdown.out: countdown.o system.o pio.o ledmat.o display.o font.o tinygl.o navswitch.o led.o timer.o task.o button.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
